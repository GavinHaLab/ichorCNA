...
1. WDL pipleine
   - The [WDL pipeline](https://github.com/GavinHaLab/ichorCNA_WDL/tree/main/WDL) uses release [ichorCNA:v0.6.1](https://github.com/GavinHaLab/ichorCNA/releases/tag/v0.6.1)
...
3. Snakemake pipeline
   - The [Snakemake pipeline](https://github.com/GavinHaLab/ichorCNA/tree/v0.7.1/scripts/snakemake) uses release source code [ichorCNA:v0.6.1](https://github.com/GavinHaLab/ichorCNA/releases/tag/v0.6.1)
