...
1. WDL pipleine
   - The [WDL pipeline](https://github.com/GavinHaLab/ichorCNA_WDL/tree/main/WDL) uses release [ichorCNA:v0.7.0](https://github.com/GavinHaLab/ichorCNA/releases/tag/v0.6.0)
